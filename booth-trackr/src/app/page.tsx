    ...
    <div className="hero bg-base-200 min-h-screen">
      <div className="hero-content text-center">
        <div className="max-w-md">
          <h1 className="text-5xl font-bold">Keep track of job booths, with ease</h1>
          <p className="py-6">
...
const uri = "mongodb+srv://bertozarate95:boothtrackr.2.@gcloud0.w6ua4zp.mongodb.net/?retryWrites=true&w=majority&appName=gcloud0";
